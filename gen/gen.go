...
const (
	header    = "// Package %s was auto-generated by github.com/posener/orm; DO NOT EDIT\n"
	pkgSuffix = "orm"
)
...
func writeTemplate(tpl *template.Template, props TemplateArgs, dir string) error {
	...
	defer f.Close()
	fmt.Fprintf(f, header, props.Package)
...
func writePackageLine(w *bufio.Writer, pkgName string) error {
	_, err := w.WriteString(fmt.Sprintf(header, pkgName) + "package " + pkgName)
	return err
}
